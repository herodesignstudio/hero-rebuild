 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'hr_deploy');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/herodesignstudio/hero-rebuild.git');
 ...
 */
define('TARGET_DIR', '/home/herodesi/public_html/_dev/hero-rebuild/');
